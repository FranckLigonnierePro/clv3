...
import { Play, Pause, Volume2, Share2, Download, Bookmark, Clock, Users, Eye } from 'lucide-vue-next'
...
const webinarData = ref({
  ...
  description: 'Learn the fundamentals of Vue 3\'s Composition API and how to build more maintainable and reusable components.',
          ...
          <div class="lg:col-span-2">
            ...
            <div class="card">
              <div class="flex flex-col lg:flex-row lg:items-start justify-between mb-4">
                <div class="flex-1">
                  <h1 class="text-2xl font-bold text-gray-900 mb-2">{{ webinarData.title }}</h1>
                  <p class="text-gray-600 mb-4">{{ webinarData.description }}</p>
            ...
            <div class="card">
              ...
              <div class="space-y-4">
                ...
                >
                  ...
                  />
                  <div class="flex-1">
                    <h4 class="font-medium text-gray-900 mb-1 line-clamp-2">{{ highlight.title }}</h4>
              ...
              <div class="space-y-2">
                ...
                >
                  ...
                  <div>
                    ...
                    <div class="text-sm text-gray-600">Trim and enhance this video</div>
                  </div>
                </router-link>
                ...
                <button class="w-full flex items-center space-x-3 p-3 text-left hover:bg-gray-50 rounded-xl transition-colors duration-200">
                  ...
                  <div>
                    ...
                    <div class="text-sm text-gray-600">Share a specific moment</div>
                  </div>
                </button>
                ...
                <button class="w-full flex items-center space-x-3 p-3 text-left hover:bg-gray-50 rounded-xl transition-colors duration-200">
                  ...
                  <div>
                    ...
                    <div class="text-sm text-gray-600">Download in different formats</div>
                  </div>
                </button>
              </div>
            </div>
