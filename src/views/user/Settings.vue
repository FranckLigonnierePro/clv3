        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
          <div class="shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 bg-white sm:p-6">
              ...
              <div class="mb-8 pb-8 border-b border-gray-200">
                ...
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6 sm:col-span-4">
                    ...
                    >
                      <svg v-if="updatingPassword" class="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
              ...
              <div class="mb-8 pb-8 border-b border-gray-200">
                <h4 class="text-md font-medium text-gray-900 mb-4">Préférences de notification</h4>
                ...
                <div class="flex items-start">
                  ...
                  <div class="ml-3 text-sm">
                    <label for="email-notifications" class="font-medium text-gray-700">Notifications par email</label>
                    <p class="text-gray-500">Recevoir des mises à jour et des notifications par email</p>
                  </div>
                </div>
              ...
              <!-- Danger Zone -->
              <div>
                <h4 class="text-md font-medium text-red-700 mb-4">Zone de danger</h4>
                
                <div class="bg-red-50 p-4 rounded-md">
                  <h5 class="text-sm font-medium text-red-800">Supprimer le compte</h5>
  ...
  setup() {
    ...
    const validatePassword = () => {
      ...
      if (!password.value.new) {
        ...
        passwordErrors.value.new = 'Le mot de passe doit contenir au moins 6 caractères';
        isValid = false;
      }
