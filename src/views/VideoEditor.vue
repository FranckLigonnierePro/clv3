...
import { Play, Pause, SkipBack, SkipForward, Scissors, Type, Download, Save, Undo, Redo } from 'lucide-vue-next'
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-8">
          ...
          <div class="flex items-center space-x-2">
            <button class="p-2 hover:bg-gray-100 rounded-xl transition-colors duration-200" title="Undo">
              <Undo class="w-5 h-5 text-gray-600" />
            </button>
            <button class="p-2 hover:bg-gray-100 rounded-xl transition-colors duration-200" title="Redo">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
              ...
              <div class="bg-black rounded-xl overflow-hidden mb-4" style="aspect-ratio: 16/9;">
                <div class="w-full h-full flex items-center justify-center text-white/60">
                  <div class="text-center">
                    ...
                    <p>Video Preview</p>
                    <p class="text-sm opacity-75">Introduction to Vue 3 Composition API</p>
                  </div>
                </div>
              </div>
            ...
            <div class="card">
              ...
              <div class="relative bg-gray-100 rounded-xl p-4 h-32">
                ...
                <div
                  ...
                  :style="{
                    ...
                    width: item.type === 'video' ? `${getTimelineWidth(item.duration)}%` : '2px'
                  }"
                  @click="selectedClip = item"
                >
                  <div v-if="item.type === 'video'" class="p-2 h-full flex items-center">
                    <span class="text-xs font-medium text-primary-800 truncate">{{ item.title }}</span>
                  </div>
                  <div v-else class="relative">
                    <div class="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-yellow-500 text-yellow-900 text-xs px-2 py-1 rounded whitespace-nowrap">
                      {{ item.title }}
                    </div>
                  </div>
                </div>
                ...
                <div
                  ...
                  :style="{ left: `${(currentTime / totalDuration) * 100}%` }"
                >
                  <div class="absolute -top-2 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-red-500 rounded-full"></div>
                </div>
              </div>
              ...
              <div class="flex items-center justify-between mt-4">
                ...
                <div class="flex items-center space-x-2">
                  ...
                  <button class="px-2 py-1 text-xs bg-gray-100 hover:bg-gray-200 rounded transition-colors duration-200">-</button>
                  <button class="px-2 py-1 text-xs bg-gray-100 hover:bg-gray-200 rounded transition-colors duration-200">+</button>
                </div>
              </div>
            </div>
          ...
          <div class="lg:col-span-1">
            <div class="card">
              <h3 class="text-lg font-semibold text-gray-900 mb-4">Editing Tools</h3>
            ...
            <div v-if="selectedClip" class="card mt-6">
              <h3 class="text-lg font-semibold text-gray-900 mb-4">Clip Details</h3>
            ...
            <div class="card mt-6">
              ...
              <div class="space-y-3">
                <div>
                  ...
                  <select class="w-full px-3 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent">
