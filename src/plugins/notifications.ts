...
const NotificationComponent = {
  ...
  setup(props: any) {
    ...
    const colorClass =
      typeColors[props.type as NotificationType] || typeColors.info;
          ...
          h("div", { class: "flex items-center" }, [
            ...
            h("div", { class: "ml-4 flex-shrink-0 flex" }, [
              h(
                ...
                {
                  class:
                    "inline-flex text-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 rounded-md",
